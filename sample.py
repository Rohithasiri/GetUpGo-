...
EXERCISE_MAP = {
    ...
    "Tree Pose": ("time_seconds_pose", lambda **kwargs: run_yoga_pose(pose_name="Tree Pose", **kwargs)),
    "Warrior Pose": ("time_seconds_pose", lambda **kwargs: run_yoga_pose(pose_name="Warrior II Pose", **kwargs)),
    "Chair Pose": ("time_seconds_pose", lambda **kwargs: run_yoga_pose(pose_name="Chair Pose", **kwargs))
}
...
# MANUAL RESULT PAGE
    ...
    if isinstance(result, dict) and result.get("status") == "Success":
        ...
        st.title("❌ Workout Failed (Manual)")
